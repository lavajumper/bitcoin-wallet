...
public class CoinDefinition {
    ...
    public static final String coinName = "Sexcoin";
    public static final String coinTicker = "SXC";
    ...
    public static final String BLOCKEXPLORER_BASE_URL_TEST = "http://betest.sexcoin.info/chain/Sexcointest/";

    public static final int MAX_MONEY = 250000000;
